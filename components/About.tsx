...
export default function About() {
  ...
  return (
    <section id="about" ref={ref} className="py-28 md:py-40 px-6 md:px-16 lg:px-24 bg-cream">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Portrait */}
        <div className={`relative w-1/2 aspect-[3/4] overflow-hidden mb-16 transition-all duration-1000 delay-100 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          <img
        ...
        <div className={`flex flex-col gap-8 transition-all duration-1000 delay-200 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          ...
          <h2 className="font-cormorant font-normal text-ink leading-tight"
          ...
          <p className="font-cormorant italic text-gold text-2xl md:text-3xl font-medium leading-snug max-w-2xl">
          ...
          <p className="font-cormorant italic text-gold text-2xl md:text-3xl font-medium leading-snug">
